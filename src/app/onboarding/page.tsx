        ...
        <div className="mx-auto max-w-2xl px-4 pt-28 pb-24 space-y-16">
          ...
          <section id="pricing" className="space-y-5">
            ...
            <div className="rounded-2xl border border-border bg-surface p-6">
              ...
              <p className="mt-1 text-xs text-muted">{yearly ? "$228 billed annually" : "Billed monthly"}</p>
              ...
              <p className="mt-2 text-xs text-muted">{yearly ? "One payment of $228/year. Cancel anytime." : "$29/month. Cancel anytime."}</p>
          ...
          <section className="space-y-5 text-center">
            <div className="rounded-2xl border border-border bg-surface px-5 py-4 text-left">
              ...
              <p className="mt-1 text-sm font-medium text-grad-light">{yearly ? "$228/year — just $19/mo. Cancel anytime." : "$29/month. Cancel anytime."}</p>
            </div>
